...
\begin{itemize}
    ...
    \item Recall $2_{\rightrightarrows}$ is the category
    \begin{tikzcd}
        \bullet \arrow[r, bend left]
                 \arrow[r, bend right]
                 & \bullet
    \end{tikzcd}.
    Then, functors $F: 2_{\rightrightarrows} \to \catname{Set}$ correspond to
    \emph{directed graphs, i.e.} structures $(V, E, s, t)$, where $V$ is a
    set of vertices, $E$ is a set of edges, and $s, t: E \to V$ specify the
    source and target vertices of each edge.
\end{itemize}
