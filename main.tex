...
\begin{solution}
    ...
    with an arrow to the empty family, there is a unique arrow from that object
    to $T$ making the corresponding diagram commute. Since there are no
    diagrams, this means there is a unique arrow from every object to $T$, and
    this is precisely the definition of a terminal object. Hence, the product
    of an empty family is a terminal object.
\end{solution}
